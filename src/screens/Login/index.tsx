				...
				<View style={tw`flex-1 px-10 justify-center bg-white mt-15`}>
					...
					<TouchableOpacity style={tw`rounded h-11 justify-center items-center bg-facebook-color mt-4`}
						...
						<View style={tw`flex-row justify-between items-center`}>
							<Image style={tw`rounded h-5 w-5 right-17`} source={require('C:/Users/Rhaniery/Documents/app-bico/bico/src/images/facebook.png')} />
					...
					<TouchableOpacity style={tw`border border-slate-300 rounded h-11 justify-center items-center bg-white mt-4`}
						...
						<View style={tw`flex-row justify-between items-center `}>
							<Image style={tw`rounded h-5 w-5 right-17`} source={require('C:/Users/Rhaniery/Documents/app-bico/bico/src/images/gmail.png')} />
					...
					<View style={tw`flex-row justify-center items-center pt-10`}>
